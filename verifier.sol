...
contract PlonkVerifier {
    ...
    uint256 constant Qlx  = 17320229834755683179396727651802722862015478520635899715065202273264717796083;
    uint256 constant Qly  = 141640178275428969309810866689701852546812155105256657888216737891717721842;
    uint256 constant Qrx  = 21315904831481110422873706081684242744943494331692208135491818815331797943781;
    uint256 constant Qry  = 21494358332627570794440471305449673540164018577554067084315042443618401169131;
    uint256 constant Qox  = 0;
    uint256 constant Qoy  = 0;
    uint256 constant Qcx  = 0;
    uint256 constant Qcy  = 0;
    uint256 constant S1x  = 12105840682202654972848432705127306379213577305700447036282411281442691268002;
    uint256 constant S1y  = 20975681078759225237432757913988543984241847851245065344343569010101008656067;
    uint256 constant S2x  = 20238671659534287425037011623872922168826338924272642163250075581757393437728;
    uint256 constant S2y  = 9275471603324609281031706622480660563972324034939804464243509215453749074223;
    uint256 constant S3x  = 3683960229883411670917878182889738897706467997041220795775083449891426955895;
    uint256 constant S3y  = 17350990444819317520481452001603001214764004640504970741625074188242566690305;
    uint256 constant k1   = 2;
    uint256 constant k2   = 3;
    uint256 constant X2x1 = 2660097833801775190781143912315683000700173963978049336001974100474008583645;
    uint256 constant X2x2 = 2725844817752606507454076748360069615756151254667699950648317870431113112982;
    uint256 constant X2y1 = 21049679876263743150347580596225551849810182034707653375133627920477594299009;
    uint256 constant X2y2 = 18538219641695783075182527635739158343462995798174974939763653232450534408288;
